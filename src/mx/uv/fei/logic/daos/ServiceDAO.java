...
public class ServiceDAO {
    ...
    public int addService(Service service) throws DataInsertionException{
        ...
        try{
            serviceStatement = dataBaseManager.getConnection().prepareStatement(serviceQuery, PreparedStatement.RETURN_GENERATED_KEYS);
            ...
            throw new DataInsertionException("Error al conectar con la base de datos, verifique su conexión e inténtelo de nuevo");
        }finally{
