                    ...
                    if(serviceDAO.isValidDate(service)){
                        try{
                            if(serviceDAO.addService(service) > 0){
                                new AlertPopUpGenerator().showCustomMessage(Alert.AlertType.INFORMATION, "Mensaje de éxito", "Mantenimiento programado exitosamente");
                        ...
                        new AlertPopUpGenerator().showCustomMessage(Alert.AlertType.WARNING, "No se puede iniciar mantenimiento", "Favor de seleccionar una fecha válida");
                    }
                }else{
                    new AlertPopUpGenerator().showCustomMessage(Alert.AlertType.WARNING, "No se puede iniciar mantenimiento", "Favor de ingresar un precio válido");
                }
            }else{
                new AlertPopUpGenerator().showCustomMessage(Alert.AlertType.WARNING, "No se puede iniciar mantenimiento", "Favor de seleccionar una fecha");
            }
        }else{
            new AlertPopUpGenerator().showCustomMessage(Alert.AlertType.WARNING, "No se puede iniciar mantenimiento", "Favor de seleccionar un tipo de servicio");
        }
    }
